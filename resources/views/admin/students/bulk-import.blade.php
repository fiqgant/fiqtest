    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="md:col-span-2 space-y-5">
            ...
            <form method="POST" action="{{ route('admin.students.bulk.preview') }}" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <p class="text-xs text-slate-400 dark:text-slate-500 mb-3">Format kolom: <code class="bg-slate-100 dark:bg-slate-700 px-1 rounded">name, nim, email(opsional)</code>. Header row diabaikan.</p>
            ...
            <form method="POST" action="{{ route('admin.students.bulk.preview') }}">
                ...
                <div class="form-section">
                    ...
                    <p class="text-xs text-slate-400 dark:text-slate-500 mb-3">One row = one student. Format: <code class="bg-slate-100 dark:bg-slate-700 px-1 rounded">name,nim</code> or <code class="bg-slate-100 dark:bg-slate-700 px-1 rounded">name,nim,email</code></p>
        ...
        <div class="space-y-4">
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
                <div class="font-semibold text-slate-700 dark:text-slate-200 mb-3"><i class="fas fa-info-circle text-indigo-500 mr-1.5"></i> Format</div>
                <table class="text-sm w-full">
                    <thead><tr class="text-xs text-slate-400 dark:text-slate-500 uppercase"><th class="text-left pb-1">Kolom</th><th class="text-left pb-1">Wajib</th></tr></thead>
                    <tbody class="text-slate-600 dark:text-slate-300 space-y-1">
