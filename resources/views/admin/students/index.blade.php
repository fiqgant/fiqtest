    ...
    <div class="card overflow-x-auto">
        <table class="data-table" style="min-width:700px">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="5" class="px-5 py-10 text-center text-slate-400"><div class="flex flex-col items-center gap-1"><i class="fas fa-users text-2xl"></i><span>No students yet.</span></div></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
