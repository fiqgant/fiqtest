    ...
    <div class="card overflow-hidden">
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="4" class="px-5 py-10 text-slate-400"><div class="flex flex-col items-center gap-1"><i class="fas fa-layer-group text-2xl"></i><span>No offerings yet.</span></div></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
